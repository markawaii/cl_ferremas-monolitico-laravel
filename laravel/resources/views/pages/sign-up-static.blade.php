            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Bienvanido a Ferremas!</h1>
                        <p class="text-lead text-white">Una ferreteria para ti</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <form role="form" method="post" action="{{ route('create-account') }}">
                                ...
                                <div class="mb-3">
                                    <input type="password" class="form-control" placeholder="Contraseña"
                                        aria-label="Contraseña" name="password">
                                </div>
                                ...
                                <p class="text-sm mt-3 mb-0">¿Ya tienes una cuenta? <a href="javascript:;"
